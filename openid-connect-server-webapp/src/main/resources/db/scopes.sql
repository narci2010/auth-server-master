...
INSERT INTO system_scope_TEMP (scope, description, icon, allow_dyn_reg, default_scope, structured, structured_param_description) VALUES
  ...
  ('patient/*.read', 'patient scope', 'user', true, true, false, null),
  ('launch/patient', 'launch patient', 'user', true, true, false, null),
  ('smart/orchestrate_launch', 'orchestrate launch', 'user', true, true, false, null),
  ('launch', 'launch', 'user', true, true, false, null),
  ('user/*.*', 'user all', 'user', true, true, false, null);
